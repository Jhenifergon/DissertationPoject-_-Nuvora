...
describe('offline banner', () => {
  ...
  it('shows when the browser goes offline, and hides again when back online', async () => {
    ...
    await screen.findByText(
      /You’re offline\. Some saves may wait until you reconnect\. Keep this page open — offline data is not stored between browser sessions\./
    );
...
describe('privacy: offline storage is explained clearly', () => {
  it('explains that signed-in mode does not persist an offline browser cache by default', async () => {
    ...
    fireEvent.click(
      await screen.findByText('Privacy & data')
    );
    ...
    fireEvent.click(
      screen.getByText('Offline storage')
    );
