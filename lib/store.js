...
function sanitizeSettings(raw) {
  ...
  return {
    calmMode: typeof r.calmMode === 'boolean' ? r.calmMode : defaultSettings.calmMode,
    reducedMotion: typeof r.reducedMotion === 'boolean' ? r.reducedMotion : defaultSettings.reducedMotion,
    textScale: typeof r.textScale === 'number' && Number.isFinite(r.textScale) ? r.textScale : defaultSettings.textScale,
    displayName: typeof r.displayName === 'string' ? r.displayName : defaultSettings.displayName,
    hideProgress: typeof r.hideProgress === 'boolean' ? r.hideProgress : defaultSettings.hideProgress,
    supportPersonName: typeof r.supportPersonName === 'string' ? r.supportPersonName : defaultSettings.supportPersonName,
    supportPersonNote: typeof r.supportPersonNote === 'string' ? r.supportPersonNote : defaultSettings.supportPersonNote,
  };
}
...
export async function loadData(uid = 'demo') {
  if (!firebaseEnabled) {
    ...
    return {
      ...
      reflections: Array.isArray(d.reflections) ? d.reflections : [],
