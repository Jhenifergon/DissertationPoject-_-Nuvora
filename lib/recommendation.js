...
//
// Why only one: a full to-do list can itself be the barrier — deciding
// where to start is often the hardest part (task initiation). Today and
// Overwhelmed Mode therefore both show a single task chosen by the same
// function, so the student is never given two different "next steps".
//
