...
export function calculatePressure(input) {
  ...
  if (score > 66) return { score, band: 'Higher', factors, message: "It looks like you're carrying a lot. Let's shrink today to one small step." };
  if (score > 33) return { score, band: 'Moderate', factors, message: "Today's answers suggest that your workload may feel difficult to manage. Let's choose one manageable next step." };
  return { score, band: 'Low', factors, message: 'Your workload feels manageable. Keep going at your own pace.' };
}
